...
// mtmt:
#define XTAL 10E6              /**< clock frequency in Hz, used to calculate delay timer */

//#define DISPLAY DISPLAYTECH162



#if DISPLAY==DISPLAYTECH162
#warning "DISPLAYTECH162"
/** 
 *  @name  Definitions for Displaytech162A 
 *  Don't Change these definitions
 *  to adapt setting to your display change USER DISPLAY and
 *  comment the #define DISPLAY line
 */
//                            DELAY in us
...
#define LCD_4BIT_MODE       1     /**< 1:using display in 4-Bit-Mode, 0: using display in 8-Bit-Mode */
#define LCD_WRAP_LINES      1     /**< 0: no wrap, 1: wrap at end of visibile line */

#define LCD_START_LINE1  0x00     /**< DDRAM address of first char of line 1 */
#define LCD_START_LINE2  0x40     /**< DDRAM address of first char of line 2 */

// hei: Scroll and autoscroll added for 2-Line Displays
...
#elif DISPLAY==DISPLAYTECH164
#warning "DISPLAYTECH164"
/** 
 *  @name  Definitions for Displaytech164A 
 *  Don't Change these definitions
 *  to adapt setting to your display change USER DISPLAY and
 *  comment the #define DISPLAY line
 */
...
/** 
 *  @name  Definitions for USER Display  
...
/**
 *  @name Definitions for 8-bit IO mode
 *  Change LCD_PORT if you want to use a different port for the LCD pins.
 *
 *  The four LCD data lines and the three control lines RS, RW, E can be on the 
 *  same port or on different ports. 
 ...
 *  different ports. 
 *
 *  The eight data lines are mapped to bit 0..7 on one port (LCD_DATA_PORT).
 */
...
#else // not in LCD_IO_MODE
#warning "Memomry Mapped Mode"
...
#else  
#error "external data memory interface not available for this device, use IO port mode"
